    ...
    <footer className="bg-surface text-on-surface mt-12">
      <div className="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted mt-2">Kerala, India, Lorem ipsum, dfsdfsdf,sdsfsdfsdf</p>
        </div>
      </div>
  <div className="border-t border-on-surface py-4 text-center text-sm text-primary-dark">© {new Date().getFullYear()} Prime Audit Solutions. All rights reserved.</div>
    </footer>
  )
}
