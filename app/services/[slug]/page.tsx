                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="max-w-4xl mt-8 text-white">
                        ...
                        <div className="mt-6 flex flex-wrap gap-3">
                            ...
                            <Link href="/contact" className="inline-flex items-center px-5 py-3 border border-white/20 rounded-full text-white/95">Contact us</Link>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <aside className="space-y-6">
                        ...
                        <div className="bg-linear-to-r from-primary/10 to-transparent rounded-xl p-5">
                            ...
                            <Link href="/contact" className="mt-4 inline-block px-4 py-2 bg-primary-dark text-white rounded">Contact us</Link>
                        </div>
                    </aside>
                </div>
